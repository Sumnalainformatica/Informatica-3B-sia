...
#### 7. il casting per conversione di tipo (p.97)
...
```
@LIA.cpp
#### 8. gli operatori di relazione e quelli logici (pag 99)
...
```
@LIA.cpp
#### 9.le istruzioni di ingresso e di uscita (pag 101)
...
#### 10.gli errori nella programmazione + le strutture di alternativa (pag 104-107)
...
#### 11. le ripetizione nel c++ (pag 111-116)
...
```
@LIA.cpp
#### 12. la struttura di scelta multipla (pag 119-121)
